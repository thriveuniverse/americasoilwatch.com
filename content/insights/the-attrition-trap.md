---
title: "The Attrition Trap: Who Runs Out of Cushion First?"
excerpt: "Even as the U.S. bombs Iran and tankers burn off Oman, oil is being shorted — proof the fight is no longer about crude availability. It is a war of attrition over buffers: the SPR, OPEC+ spare capacity, diesel stocks, and Iran's own economy. The U.S. is both the system's cushion and the most exposed to spending it."
date: "2026-06-27"
author: "Jon Kelly"
tags: ["SPR", "Inventories", "OPEC", "Spare Capacity", "Iran", "Diesel", "PADD 5", "Resilience", "EIA"]
---
...
That is the **attrition trap**, and the thinnest cushion of all is not crude but **product** — diesel (see [Crude Is Falling, Diesel Isn't](/insights/diesel-the-hidden-stress-point) and [The Oil Crisis Is Moving Downstream](/insights/oil-crisis-moving-downstream)). You can model the depletion arithmetic on our [inventory runway tool](/runway).
...
The U.S. is both the system's cushion *and* the most exposed to spending it. It has been the world's emergency refiner and swing supplier — drawing down its own SPR and **West Coast (PADD 5) distillate stocks** (already at critical seasonal lows) to keep Europe and Asia supplied. That is the **exporter's paradox in buffer form**: the more the Americas backstop the world, the thinner their own cushion gets, and the longer (and pricier) the road back to refill. Here the numbers to watch are the SPR refill timeline and West Coast product stocks — not the Brent print.
