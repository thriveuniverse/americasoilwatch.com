...
That is the **attrition trap**, and the thinnest cushion of all is not crude but **product** — diesel (see [Crude Is Falling, Diesel Isn't](/analysis/diesel-the-hidden-stress-point) and [The Oil Crisis Is Moving Downstream](/analysis/oil-crisis-moving-downstream)). You can model the depletion arithmetic on our [inventory runway tool](/runway).
...
Britain is the most exposed of all: it holds **no meaningful strategic reserve of its own**, runs on a matter of days of commercial cover, and imports much of its refined product. In an attrition fight over buffers, the UK is a price-taker with the smallest cushion — fully dependent on the global one holding. That is why the diesel premium and import routes, not the Brent headline, are the numbers that reach the British economy.
