...
export const metadata: Metadata = {
  title: 'Compound Cascade Systems Modelling — Methodology Framework | AmericasOilWatch',
  description:
  ...
  alternates: { canonical: 'https://americasoilwatch.com/methodology/compound-cascade' },
  openGraph: {
    ...
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <footer className="border-t border-oil-800/40 pt-6 mt-8 space-y-3 text-xs text-gray-500">
        ...
        <p>
          ...
          <a href="https://eurooilwatch.com/methodology/compound-cascade" className="text-oil-400 hover:underline">eurooilwatch.com</a>
          {' · '}
