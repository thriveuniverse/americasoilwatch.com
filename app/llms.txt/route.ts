...
- Russia Is Importing Fuel While Exporting Crude — one of the world's largest crude producers has begun importing gasoline (from Belarus, India and Kazakhstan) while banning its own fuel exports to end-2026: the clearest measure of Ukraine's refinery campaign. Producing crude and refining it are different capabilities that fail differently; attacks on the concentrated, sanction-starved conversion and logistics system have forced domestic shortages, export bans and imports — tightening global diesel (European stocks lowest since 2022, cracks near ~$65): https://americasoilwatch.com/analysis/russia-importing-fuel-exporting-crude
- Oil Falls 6%, Inflation Fears Ease — but the Fuel Market Is Still Tight — Monday's ~6% crude drop is genuine US relief (bonds, equities, airlines, eventual pump, easier Fed read), but it is price relief, not supply relief: EIA gasoline/distillate stocks rose w/w yet stayed 7% and 10% below the 5-yr average with refineries at 96.1% of operable capacity, and the US (the world's largest diesel exporter) faces global product tightness. The barrel and the fuel buffer are two different stories: https://americasoilwatch.com/analysis/oil-down-fuel-market-still-tight
