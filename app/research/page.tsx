...
export const metadata: Metadata = {
  title: 'Research — the Compound Cascade framework & Institutional Failure typology | AmericasOilWatch',
  description:
    'The analytical backbone beneath AmericasOilWatch: an original framework for how systemic crises propagate (Compound Cascade Systems Modelling), its companion typology of why institutions fail to see them coming (Institutional Failure Mode Typology), and the interactive instruments that put both to work.',
  alternates: { canonical: 'https://americasoilwatch.com/research' },
  openGraph: {
    ...
    url: 'https://americasoilwatch.com/research',
...
const LD = {
  ...
  '@type': 'CollectionPage',
  name: 'Research — AmericasOilWatch',
  url: 'https://americasoilwatch.com/research',
  description:
    'Original research underlying AmericasOilWatch: the Compound Cascade Systems Modelling framework and the Institutional Failure Mode Typology, with the interactive instruments that operationalise them.',
  author: { '@type': 'Person', name: 'Jonathan Kelly' },
  publisher: { '@type': 'Organization', name: 'AmericasOilWatch', url: 'https://americasoilwatch.com' },
  hasPart: [
    {
      '@type': 'CreativeWork',
      name: 'Compound Cascade Systems Modelling Framework',
      url: 'https://americasoilwatch.com/methodology/compound-cascade',
      author: { '@type': 'Person', name: 'Jonathan Kelly' },
    },
    {
      '@type': 'CreativeWork',
      name: 'Institutional Failure Mode Typology',
      url: 'https://americasoilwatch.com/analysis/institutional-failure-typology',
      author: { '@type': 'Person', name: 'Jonathan Kelly' },
    },
  ],
};
    ...
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      <section className="space-y-4">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <a href="/insights/oil-crisis-moving-downstream" className="block rounded-lg border border-oil-800 bg-oil-900/30 px-6 py-5 space-y-2 hover:border-oil-600 transition">
