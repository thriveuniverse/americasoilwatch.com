...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `https://americasoilwatch.com/analysis/${params.slug}`,
    },
    openGraph: {
      title: data.title,
      description: data.excerpt,
      url: `https://americasoilwatch.com/analysis/${params.slug}`,
...
export default function ArticlePage({
  ...
  return (
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <div className="pt-4 pb-4 border-t border-oil-800">
        <a href="/analysis" className="text-xs text-oil-400 hover:underline">
          ← Back to Analysis
        </a>
      </div>
