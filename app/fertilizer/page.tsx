...
export const metadata: Metadata = {
  title: 'Fertilizer Watch — The Hormuz-to-Hunger Operational Tracker | AmericasOilWatch',
  description:
    'Live editorial tracker of global urea, ammonia, DAP, potash and TTF natural gas prices. The operational layer beneath the From Hormuz to Hunger analysis.',
  alternates: { canonical: 'https://americasoilwatch.com/fertilizer' },
  openGraph: {
    ...
    url: 'https://americasoilwatch.com/fertilizer',
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      <section className="space-y-4">
        <h2 className="text-2xl font-bold text-white">Why it matters in the Americas</h2>
        <p className="text-[15px] text-gray-300 leading-relaxed">
          The Americas have a real cushion the rest of the world lacks: US domestic nitrogen capacity at scale
          (CF Industries&apos; Donaldsonville and Yazoo City urea / ammonia complexes), Canadian potash (Nutrien
          in Saskatchewan), and a hemisphere food-export role that makes US grain itself the buffer for many
          import-dependent countries.
        </p>
        <p className="text-[15px] text-gray-300 leading-relaxed">
          That cushion is real but it isn&apos;t infinite. Brazil — the world&apos;s third-largest agricultural
          exporter — imports the bulk of its nitrogen needs, heavily from Gulf and Russian sources. Mexico,
          Caribbean nations, and Central American agriculture all run import-dependent inputs through Gulf
          shipping. And US food exports themselves carry hemisphere food security on their back, which means when
          US farmers face higher input costs, the second-order effects show up first in São Paulo, Mexico City
          and Port-au-Prince — not in Houston.
        </p>
      </section>
      ...
      <SubscribeCta variant="full" headline="Track this every week — get our briefing" />
      ...
      <footer className="border-t border-oil-800/40 pt-6 mt-8 space-y-3 text-xs text-gray-500">
        <p>
          ...
          {' · '}
          <a href="https://eurooilwatch.com/fertilizer" className="text-oil-400 hover:underline">eurooilwatch.com</a>
        </p>
        <p>
