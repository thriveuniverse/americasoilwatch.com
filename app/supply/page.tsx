...
const CHOKEPOINTS: Chokepoint[] = [
  {
    ...
    summary: 'The Strait of Hormuz remains the master variable for global oil. After the conflict that began in late February 2026 effectively closed it, the EIA assumed Hormuz stayed shut into late May, with traffic only beginning to pick up in June. Iran now says it will reopen only under new conditions — including possible Oman-set transit fees, which Washington opposes. All major Gulf producers export through this single chokepoint; flows are limited and negotiated — Hormuz may be reopening in form, but not yet in function.',
