 ...
 * Creates the AmericasOilWatch segment and topic, then prints the IDs
...
async function main() {
  console.log('Setting up Resend for AmericasOilWatch...\n');

  console.log('Creating segment "AmericasOilWatch"...');
  const segmentId = await createSegment('AmericasOilWatch');
  console.log(`✓ Segment created: ${segmentId}`);

  console.log('Creating topic "AmericasOilWatch Weekly"...');
  const topicId = await createTopic('AmericasOilWatch Weekly');
